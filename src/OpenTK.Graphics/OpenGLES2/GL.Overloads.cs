...
namespace OpenTK.Graphics.OpenGLES2
{
    public static unsafe partial class GL
    {
        ...
        /// <inheritdoc cref="BindAttribLocation(int, uint, byte*)"/>
        public static unsafe void BindAttribLocation(int program, uint index, ReadOnlySpan<byte> nullTerminatedUtf8Name)
        {
            var nullTerminatedUtf8Name_span = NativeString.EnsureNullTerminated(nullTerminatedUtf8Name, out var nullTerminatedUtf8Name_array);
            fixed (byte* name_ptr = nullTerminatedUtf8Name_span)
            {
                BindAttribLocation(program, index, name_ptr);
            }
            if (nullTerminatedUtf8Name_array is not null) ArrayPool<byte>.Shared.Return(nullTerminatedUtf8Name_array, true);
        }
        ...
        /// <inheritdoc cref="BufferData{T1}(BufferTarget, ReadOnlySpan{T1}, BufferUsage)"/>
        public static unsafe void BufferData<T1>(BufferTarget target, Span<T1> data, BufferUsage usage)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> data_r = data;
            BufferData(target, data_r, usage);
        }
        /// <inheritdoc cref="BufferData(BufferTarget, nint, void*, BufferUsage)"/>
        ...
        /// <inheritdoc cref="BufferSubData{T1}(BufferTarget, IntPtr, ReadOnlySpan{T1})"/>
        public static unsafe void BufferSubData<T1>(BufferTarget target, IntPtr offset, Span<T1> data)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> data_r = data;
            BufferSubData(target, offset, data_r);
        }
        /// <inheritdoc cref="BufferSubData(BufferTarget, IntPtr, nint, void*)"/>
        ...
        /// <inheritdoc cref="CompressedTexImage2D{T1}(TextureTarget, int, InternalFormat, int, int, int, ReadOnlySpan{T1})"/>
        public static unsafe void CompressedTexImage2D<T1>(TextureTarget target, int level, InternalFormat internalformat, int width, int height, int border, Span<T1> data)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> data_r = data;
            CompressedTexImage2D(target, level, internalformat, width, height, border, data_r);
        }
        /// <inheritdoc cref="CompressedTexImage2D(TextureTarget, int, InternalFormat, int, int, int, int, void*)"/>
            ...
            where T1 : unmanaged
        {
            fixed (void* data_ptr = data)
            {
                var imageSize = data.Length;
                imageSize = checked(imageSize * Unsafe.SizeOf<T1>());
        ...
        /// <inheritdoc cref="CompressedTexImage3D{T1}(TextureTarget, int, InternalFormat, int, int, int, int, ReadOnlySpan{T1})"/>
        public static unsafe void CompressedTexImage3D<T1>(TextureTarget target, int level, InternalFormat internalformat, int width, int height, int depth, int border, Span<T1> data)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> data_r = data;
            CompressedTexImage3D(target, level, internalformat, width, height, depth, border, data_r);
        }
        /// <inheritdoc cref="CompressedTexImage3D(TextureTarget, int, InternalFormat, int, int, int, int, int, void*)"/>
        ...
        /// <inheritdoc cref="CompressedTexSubImage2D{T1}(TextureTarget, int, int, int, int, int, InternalFormat, ReadOnlySpan{T1})"/>
        public static unsafe void CompressedTexSubImage2D<T1>(TextureTarget target, int level, int xoffset, int yoffset, int width, int height, InternalFormat format, Span<T1> data)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> data_r = data;
            CompressedTexSubImage2D(target, level, xoffset, yoffset, width, height, format, data_r);
        }
        /// <inheritdoc cref="CompressedTexSubImage2D(TextureTarget, int, int, int, int, int, InternalFormat, int, void*)"/>
        ...
        /// <inheritdoc cref="CompressedTexSubImage3D{T1}(TextureTarget, int, int, int, int, int, int, int, InternalFormat, ReadOnlySpan{T1})"/>
        public static unsafe void CompressedTexSubImage3D<T1>(TextureTarget target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, InternalFormat format, Span<T1> data)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> data_r = data;
            CompressedTexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, data_r);
        }
        /// <inheritdoc cref="CompressedTexSubImage3D(TextureTarget, int, int, int, int, int, int, int, InternalFormat, int, void*)"/>
        ...
        /// <inheritdoc cref="DebugMessageCallback{T1}(GLDebugProc, ReadOnlySpan{T1})"/>
        public static unsafe void DebugMessageCallback<T1>(GLDebugProc callback, Span<T1> userParam)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> userParam_r = userParam;
            DebugMessageCallback(callback, userParam_r);
        }
        /// <inheritdoc cref="DebugMessageCallback(IntPtr, void*)"/>
        ...
        /// <inheritdoc cref="DrawArraysIndirect{T1}(PrimitiveType, ReadOnlySpan{T1})"/>
        public static unsafe void DrawArraysIndirect<T1>(PrimitiveType mode, Span<T1> indirect)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> indirect_r = indirect;
            DrawArraysIndirect(mode, indirect_r);
        }
        /// <inheritdoc cref="DrawArraysIndirect(PrimitiveType, void*)"/>
        ...
        /// <inheritdoc cref="DrawElementsIndirect{T1}(PrimitiveType, DrawElementsType, ReadOnlySpan{T1})"/>
        public static unsafe void DrawElementsIndirect<T1>(PrimitiveType mode, DrawElementsType type, Span<T1> indirect)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> indirect_r = indirect;
            DrawElementsIndirect(mode, type, indirect_r);
        }
        /// <inheritdoc cref="DrawElementsIndirect(PrimitiveType, DrawElementsType, void*)"/>
        ...
        public static unsafe void GetActiveAttrib(int program, uint index, out int length, out int size, out AttributeType type, Span<byte> name)
        {
        ...
        public static unsafe void GetActiveUniform(int program, uint index, out int length, out int size, out UniformType type, Span<byte> name)
        {
            fixed (int* length_ptr = &length)
            fixed (int* size_ptr = &size)
        ...
        public static unsafe void GetActiveUniformBlockName(int program, uint uniformBlockIndex, out int length, Span<byte> uniformBlockName)
        {
            fixed (int* length_ptr = &length)
            {
                fixed (byte* uniformBlockName_ptr = uniformBlockName)
                {
                    var bufSize = uniformBlockName.Length;
        ...
        /// <inheritdoc cref="GetActiveUniformsiv(int, int, uint*, UniformPName, int*)"/>
        public static unsafe void GetActiveUniformsi(int program, ReadOnlySpan<uint> uniformIndices, UniformPName pname, out int parameters)
        {
            fixed (int* parameters_ptr = &parameters)
            {
                fixed (uint* uniformIndices_ptr = uniformIndices)
        ...
        /// <inheritdoc cref="GetActiveUniformsiv(int, int, uint*, UniformPName, int*)"/>
        public static unsafe void GetActiveUniformsi(int program, ReadOnlySpan<uint> uniformIndices, UniformPName pname, int[] parameters)
        {
            fixed (int* parameters_ptr = parameters)
            {
                fixed (uint* uniformIndices_ptr = uniformIndices)
        ...
        /// <inheritdoc cref="GetActiveUniformsiv(int, int, uint*, UniformPName, int*)"/>
        public static unsafe void GetActiveUniformsi(int program, int uniformCount, ref readonly uint uniformIndices, UniformPName pname, Span<int> parameters)
        {
            fixed (uint* uniformIndices_ptr = &uniformIndices)
            {
                fixed (int* parameters_ptr = parameters)
        ...
        public static unsafe void GetAttachedShaders(int program, out int count, Span<int> shaders)
        {
            fixed (int* count_ptr = &count)
            {
                fixed (int* shaders_ptr = shaders)
                {
                    var maxCount = shaders.Length;
        ...
        /// <inheritdoc cref="GetAttribLocation(int, byte*)"/>
        public static unsafe int GetAttribLocation(int program, ReadOnlySpan<byte> nullTerminatedUtf8Name)
        {
            int returnValue;
            var nullTerminatedUtf8Name_span = NativeString.EnsureNullTerminated(nullTerminatedUtf8Name, out var nullTerminatedUtf8Name_array);
            fixed (byte* name_ptr = nullTerminatedUtf8Name_span)
        ...
        public static unsafe uint GetDebugMessageLog(uint count, ref DebugSource sources, ref DebugType types, ref uint ids, ref DebugSeverity severities, ref int lengths, Span<byte> messageLog)
        {
            ...
            {
                fixed (byte* messageLog_ptr = messageLog)
                {
                    var bufSize = messageLog.Length;
        ...
        /// <inheritdoc cref="GetDebugMessageLog(uint, int, DebugSource*, DebugType*, uint*, DebugSeverity*, int*, byte*)"/>
        public static unsafe uint GetDebugMessageLog(uint count, DebugSource[] sources, DebugType[] types, uint[] ids, DebugSeverity[] severities, int[] lengths, Span<byte> messageLog)
        {
            uint returnValue;
            fixed (int* lengths_ptr = lengths)
            {
        ...
        /// <inheritdoc cref="GetDebugMessageLog(uint, int, DebugSource*, DebugType*, uint*, DebugSeverity*, int*, byte*)"/>
        public static unsafe uint GetDebugMessageLog(uint count, Span<DebugSource> sources, Span<DebugType> types, Span<uint> ids, Span<DebugSeverity> severities, Span<int> lengths, Span<byte> messageLog)
        {
            uint returnValue;
            fixed (int* lengths_ptr = lengths)
            {
        ...
        /// <inheritdoc cref="GetFragDataLocation(int, byte*)"/>
        public static unsafe int GetFragDataLocation(int program, ReadOnlySpan<byte> nullTerminatedUtf8Name)
        {
            int returnValue;
            var nullTerminatedUtf8Name_span = NativeString.EnsureNullTerminated(nullTerminatedUtf8Name, out var nullTerminatedUtf8Name_array);
            fixed (byte* name_ptr = nullTerminatedUtf8Name_span)
        ...
        public static unsafe void GetObjectLabel(ObjectIdentifier identifier, uint name, out int length, Span<byte> label)
        {
            fixed (int* length_ptr = &length)
            {
        ...
        public static unsafe void GetObjectPtrLabel(IntPtr ptr, out int length, Span<byte> label)
        {
            fixed (int* length_ptr = &length)
            {
                fixed (byte* label_ptr = label)
        ...
        /// <inheritdoc cref="GetObjectPtrLabel(void*, int, int*, byte*)"/>
        public static unsafe void GetObjectPtrLabel<T1>(ref readonly T1 ptr, out int length, Span<byte> label)
            where T1 : unmanaged
        {
        ...
        /// <inheritdoc cref="GetObjectPtrLabel(void*, int, int*, byte*)"/>
        public static unsafe void GetObjectPtrLabel<T1>(T1[] ptr, out int length, Span<byte> label)
            where T1 : unmanaged
        {
            fixed (int* length_ptr = &length)
            {
        ...
        /// <inheritdoc cref="GetObjectPtrLabel{T1}(ReadOnlySpan{T1}, out int, Span{byte})"/>
        public static unsafe void GetObjectPtrLabel<T1>(Span<T1> ptr, out int length, Span<byte> label)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> ptr_r = ptr;
            GetObjectPtrLabel(ptr_r, out length, label);
        }
        /// <inheritdoc cref="GetObjectPtrLabel(void*, int, int*, byte*)"/>
        public static unsafe void GetObjectPtrLabel<T1>(ReadOnlySpan<T1> ptr, out int length, Span<byte> label)
            where T1 : unmanaged
        {
            fixed (int* length_ptr = &length)
            {
        ...
        /// <inheritdoc cref="GetObjectPtrLabel{T1}(ReadOnlySpan{T1}, int, out int)"/>
        public static unsafe string GetObjectPtrLabel<T1>(Span<T1> ptr, int bufSize, out int length)
            where T1 : unmanaged
        {
            string returnValue;
            ReadOnlySpan<T1> ptr_r = ptr;
            returnValue = GetObjectPtrLabel(ptr_r, bufSize, out length);
            return returnValue;
        }
        /// <inheritdoc cref="GetObjectPtrLabel(void*, int, int*, byte*)"/>
        ...
        /// <inheritdoc cref="GetObjectPtrLabel{T1}(ReadOnlySpan{T1}, int, out int, out string)"/>
        public static unsafe void GetObjectPtrLabel<T1>(Span<T1> ptr, int bufSize, out int length, out string label)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> ptr_r = ptr;
            GetObjectPtrLabel(ptr_r, bufSize, out length, out label);
        }
        /// <inheritdoc cref="GetObjectPtrLabel(void*, int, int*, byte*)"/>
        ...
        /// <inheritdoc cref="GetProgramBinary(int, int, int*, All*, void*)"/>
        public static unsafe void GetProgramBinary<T1>(int program, out int length, out All binaryFormat, Span<T1> binary)
            where T1 : unmanaged
        {
            fixed (int* length_ptr = &length)
            fixed (All* binaryFormat_ptr = &binaryFormat)
            {
                ...
                {
                    var bufSize = binary.Length;
                    bufSize = checked(bufSize * Unsafe.SizeOf<T1>());
        ...
        public static unsafe void GetProgramInfoLog(int program, out int length, Span<byte> infoLog)
        {
            fixed (int* length_ptr = &length)
            {
                fixed (byte* infoLog_ptr = infoLog)
                {
                    var bufSize = infoLog.Length;
        ...
        public static unsafe void GetProgramPipelineInfoLog(int pipeline, out int length, Span<byte> infoLog)
        {
            fixed (int* length_ptr = &length)
            {
                fixed (byte* infoLog_ptr = infoLog)
        ...
        /// <inheritdoc cref="GetProgramResourceIndex(int, ProgramInterface, byte*)"/>
        public static unsafe uint GetProgramResourceIndex(int program, ProgramInterface programInterface, ReadOnlySpan<byte> nullTerminatedUtf8Name)
        {
            uint returnValue;
            var nullTerminatedUtf8Name_span = NativeString.EnsureNullTerminated(nullTerminatedUtf8Name, out var nullTerminatedUtf8Name_array);
            fixed (byte* name_ptr = nullTerminatedUtf8Name_span)
        ...
        public static unsafe void GetProgramResourcei(int program, ProgramInterface programInterface, uint index, ReadOnlySpan<ProgramResourceProperty> props, out int length, Span<int> parameters)
        {
            fixed (int* length_ptr = &length)
            {
                fixed (int* parameters_ptr = parameters)
        ...
        /// <inheritdoc cref="GetProgramResourceLocation(int, ProgramInterface, byte*)"/>
        public static unsafe int GetProgramResourceLocation(int program, ProgramInterface programInterface, ReadOnlySpan<byte> nullTerminatedUtf8Name)
        {
            int returnValue;
            var nullTerminatedUtf8Name_span = NativeString.EnsureNullTerminated(nullTerminatedUtf8Name, out var nullTerminatedUtf8Name_array);
            fixed (byte* name_ptr = nullTerminatedUtf8Name_span)
        ...
        public static unsafe void GetProgramResourceName(int program, ProgramInterface programInterface, uint index, out int length, Span<byte> name)
        {
            fixed (int* length_ptr = &length)
            {
                fixed (byte* name_ptr = name)
        ...
        public static unsafe void GetShaderInfoLog(int shader, out int length, Span<byte> infoLog)
        {
            fixed (int* length_ptr = &length)
            {
                fixed (byte* infoLog_ptr = infoLog)
        ...
        public static unsafe void GetShaderSource(int shader, out int length, Span<byte> source)
        {
            fixed (int* length_ptr = &length)
            {
                fixed (byte* source_ptr = source)
                {
                    var bufSize = source.Length;
        ...
        public static unsafe string? GetString(StringName name, [ConstantExpected] NativeCharacterEncoding resultEncoding = NativeCharacterEncoding.Utf8)
        {
        ...
        public static unsafe void GetSynci(GLSync sync, SyncParameterName pname, out int length, Span<int> values)
        {
            fixed (int* length_ptr = &length)
            {
        ...
        public static unsafe void GetTransformFeedbackVarying(int program, uint index, out int length, out int size, out AttributeType type, Span<byte> name)
        {
            fixed (int* length_ptr = &length)
            fixed (int* size_ptr = &size)
            fixed (AttributeType* type_ptr = &type)
        ...
        /// <inheritdoc cref="GetUniformBlockIndex(int, byte*)"/>
        public static unsafe uint GetUniformBlockIndex(int program, ReadOnlySpan<byte> nullTerminatedUtf8UniformBlockName)
        {
            uint returnValue;
            var nullTerminatedUtf8UniformBlockName_span = NativeString.EnsureNullTerminated(nullTerminatedUtf8UniformBlockName, out var nullTerminatedUtf8UniformBlockName_array);
            fixed (byte* uniformBlockName_ptr = nullTerminatedUtf8UniformBlockName_span)
            {
                returnValue = GetUniformBlockIndex(program, uniformBlockName_ptr);
            }
            if (nullTerminatedUtf8UniformBlockName_array is not null) ArrayPool<byte>.Shared.Return(nullTerminatedUtf8UniformBlockName_array, true);
            return returnValue;
        }
        ...
        /// <inheritdoc cref="GetUniformLocation(int, byte*)"/>
        public static unsafe int GetUniformLocation(int program, ReadOnlySpan<byte> nullTerminatedUtf8Name)
        {
            int returnValue;
            var nullTerminatedUtf8Name_span = NativeString.EnsureNullTerminated(nullTerminatedUtf8Name, out var nullTerminatedUtf8Name_array);
            fixed (byte* name_ptr = nullTerminatedUtf8Name_span)
        ...
        /// <inheritdoc cref="ObjectPtrLabel{T1}(ReadOnlySpan{T1}, int, string)"/>
        public static unsafe void ObjectPtrLabel<T1>(Span<T1> ptr, int length, string label)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> ptr_r = ptr;
            ObjectPtrLabel(ptr_r, length, label);
        }
        /// <inheritdoc cref="ObjectPtrLabel(void*, int, byte*)"/>
        ...
        /// <inheritdoc cref="ObjectPtrLabel(void*, int, byte*)"/>
        public static unsafe void ObjectPtrLabel<T1>(ref readonly T1 ptr, int length, ReadOnlySpan<byte> nullTerminatedUtf8Label)
            where T1 : unmanaged
        {
            fixed (void* ptr_ptr = &ptr)
            {
        ...
        /// <inheritdoc cref="ObjectPtrLabel(void*, int, byte*)"/>
        public static unsafe void ObjectPtrLabel<T1>(T1[] ptr, int length, ReadOnlySpan<byte> nullTerminatedUtf8Label)
            where T1 : unmanaged
        {
            fixed (void* ptr_ptr = ptr)
            {
        ...
        public static unsafe void ObjectPtrLabel<T1>(Span<T1> ptr, int length, ReadOnlySpan<byte> nullTerminatedUtf8Label)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> ptr_r = ptr;
            ObjectPtrLabel(ptr_r, length, nullTerminatedUtf8Label);
        }
        /// <inheritdoc cref="ObjectPtrLabel(void*, int, byte*)"/>
        public static unsafe void ObjectPtrLabel<T1>(ReadOnlySpan<T1> ptr, int length, ReadOnlySpan<byte> nullTerminatedUtf8Label)
            where T1 : unmanaged
        {
            fixed (void* ptr_ptr = ptr)
            {
        ...
        /// <inheritdoc cref="ProgramBinary{T1}(int, All, ReadOnlySpan{T1})"/>
        public static unsafe void ProgramBinary<T1>(int program, All binaryFormat, Span<T1> binary)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> binary_r = binary;
            ProgramBinary(program, binaryFormat, binary_r);
        }
        /// <inheritdoc cref="ProgramBinary(int, All, void*, int)"/>
        ...
        /// <inheritdoc cref="ShaderBinary{T1}(ReadOnlySpan{int}, ShaderBinaryFormat, ReadOnlySpan{T1})"/>
        public static unsafe void ShaderBinary<T1>(ReadOnlySpan<int> shaders, ShaderBinaryFormat binaryFormat, Span<T1> binary)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> binary_r = binary;
            ShaderBinary(shaders, binaryFormat, binary_r);
        }
        /// <inheritdoc cref="ShaderBinary(int, int*, ShaderBinaryFormat, void*, int)"/>
        ...
        /// <inheritdoc cref="TexImage2D{T1}(TextureTarget, int, InternalFormat, int, int, int, PixelFormat, PixelType, ReadOnlySpan{T1})"/>
        public static unsafe void TexImage2D<T1>(TextureTarget target, int level, InternalFormat internalformat, int width, int height, int border, PixelFormat format, PixelType type, Span<T1> pixels)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> pixels_r = pixels;
            TexImage2D(target, level, internalformat, width, height, border, format, type, pixels_r);
        }
        /// <inheritdoc cref="TexImage2D(TextureTarget, int, InternalFormat, int, int, int, PixelFormat, PixelType, void*)"/>
        ...
        /// <inheritdoc cref="TexImage3D{T1}(TextureTarget, int, InternalFormat, int, int, int, int, PixelFormat, PixelType, ReadOnlySpan{T1})"/>
        public static unsafe void TexImage3D<T1>(TextureTarget target, int level, InternalFormat internalformat, int width, int height, int depth, int border, PixelFormat format, PixelType type, Span<T1> pixels)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> pixels_r = pixels;
            TexImage3D(target, level, internalformat, width, height, depth, border, format, type, pixels_r);
        }
        /// <inheritdoc cref="TexImage3D(TextureTarget, int, InternalFormat, int, int, int, int, PixelFormat, PixelType, void*)"/>
        ...
        /// <inheritdoc cref="TexSubImage2D{T1}(TextureTarget, int, int, int, int, int, PixelFormat, PixelType, ReadOnlySpan{T1})"/>
        public static unsafe void TexSubImage2D<T1>(TextureTarget target, int level, int xoffset, int yoffset, int width, int height, PixelFormat format, PixelType type, Span<T1> pixels)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> pixels_r = pixels;
            TexSubImage2D(target, level, xoffset, yoffset, width, height, format, type, pixels_r);
        }
        /// <inheritdoc cref="TexSubImage2D(TextureTarget, int, int, int, int, int, PixelFormat, PixelType, void*)"/>
        ...
        /// <inheritdoc cref="TexSubImage3D{T1}(TextureTarget, int, int, int, int, int, int, int, PixelFormat, PixelType, ReadOnlySpan{T1})"/>
        public static unsafe void TexSubImage3D<T1>(TextureTarget target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, PixelFormat format, PixelType type, Span<T1> pixels)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> pixels_r = pixels;
            TexSubImage3D(target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, pixels_r);
        }
        /// <inheritdoc cref="TexSubImage3D(TextureTarget, int, int, int, int, int, int, int, PixelFormat, PixelType, void*)"/>
        ...
        public static unsafe partial class AMD
        {
            ...
            public static unsafe void GetPerfMonitorCountersAMD(uint group, out int numCounters, out int maxActiveCounters, Span<uint> counters)
            {
            ...
            public static unsafe void GetPerfMonitorCounterStringAMD(uint group, uint counter, out int length, Span<byte> counterString)
            {
                fixed (int* length_ptr = &length)
                {
                    fixed (byte* counterString_ptr = counterString)
                    {
                        var bufSize = counterString.Length;
            ...
            public static unsafe void GetPerfMonitorGroupsAMD(out int numGroups, Span<uint> groups)
            {
                fixed (int* numGroups_ptr = &numGroups)
                {
                    fixed (uint* groups_ptr = groups)
                    {
                        var groupsSize = groups.Length;
            ...
            public static unsafe void GetPerfMonitorGroupStringAMD(uint group, out int length, Span<byte> groupString)
            {
                fixed (int* length_ptr = &length)
                {
                    fixed (byte* groupString_ptr = groupString)
                    {
                        var bufSize = groupString.Length;
            ...
            public static unsafe void SelectPerfMonitorCountersAMD(uint monitor, bool enable, uint group, Span<uint> counterList)
            {
                ...
                {
                    var numCounters = counterList.Length;
        ...
        public static unsafe partial class ANGLE
        {
            ...
            public static unsafe void GetTranslatedShaderSourceANGLE(int shader, out int length, Span<byte> source)
            {
                fixed (int* length_ptr = &length)
                {
                    fixed (byte* source_ptr = source)
        ...
        public static unsafe partial class APPLE
        {
            ...
            /// <inheritdoc cref="GetSyncivAPPLE(GLSync, SyncParameterName, int, int*, int*)"/>
            public static unsafe void GetSyncivAPPLE(GLSync sync, SyncParameterName pname, int[] length, Span<int> values)
            {
                fixed (int* length_ptr = length)
                {
                    fixed (int* values_ptr = values)
            ...
            /// <inheritdoc cref="GetSyncivAPPLE(GLSync, SyncParameterName, int, int*, int*)"/>
            public static unsafe void GetSyncivAPPLE(GLSync sync, SyncParameterName pname, Span<int> length, Span<int> values)
            {
                fixed (int* length_ptr = length)
                {
                    fixed (int* values_ptr = values)
            ...
            /// <inheritdoc cref="GetSyncivAPPLE(GLSync, SyncParameterName, int, int*, int*)"/>
            public static unsafe void GetSyncivAPPLE(GLSync sync, SyncParameterName pname, int count, Span<int> length, ref int values)
            {
                fixed (int* values_ptr = &values)
                {
                    fixed (int* length_ptr = length)
        ...
        public static unsafe partial class EXT
        {
            ...
            /// <inheritdoc cref="BindFragDataLocationEXT(int, uint, byte*)"/>
            public static unsafe void BindFragDataLocationEXT(int program, uint color, ReadOnlySpan<byte> nullTerminatedUtf8Name)
            {
                var nullTerminatedUtf8Name_span = NativeString.EnsureNullTerminated(nullTerminatedUtf8Name, out var nullTerminatedUtf8Name_array);
                fixed (byte* name_ptr = nullTerminatedUtf8Name_span)
                {
            ...
            /// <inheritdoc cref="BindFragDataLocationIndexedEXT(int, uint, uint, byte*)"/>
            public static unsafe void BindFragDataLocationIndexedEXT(int program, uint colorNumber, uint index, ReadOnlySpan<byte> nullTerminatedUtf8Name)
            {
                var nullTerminatedUtf8Name_span = NativeString.EnsureNullTerminated(nullTerminatedUtf8Name, out var nullTerminatedUtf8Name_array);
                fixed (byte* name_ptr = nullTerminatedUtf8Name_span)
                {
            ...
            /// <inheritdoc cref="BufferStorageEXT{T1}(BufferStorageTarget, ReadOnlySpan{T1}, BufferStorageMask)"/>
            public static unsafe void BufferStorageEXT<T1>(BufferStorageTarget target, Span<T1> data, BufferStorageMask flags)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> data_r = data;
                BufferStorageEXT(target, data_r, flags);
            }
            /// <inheritdoc cref="BufferStorageEXT(BufferStorageTarget, nint, void*, BufferStorageMask)"/>
            ...
            /// <inheritdoc cref="ClearTexImageEXT{T1}(int, int, PixelFormat, PixelType, ReadOnlySpan{T1})"/>
            public static unsafe void ClearTexImageEXT<T1>(int texture, int level, PixelFormat format, PixelType type, Span<T1> data)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> data_r = data;
                ClearTexImageEXT(texture, level, format, type, data_r);
            }
            /// <inheritdoc cref="ClearTexImageEXT(int, int, PixelFormat, PixelType, void*)"/>
            ...
            /// <inheritdoc cref="ClearTexSubImageEXT{T1}(int, int, int, int, int, int, int, int, PixelFormat, PixelType, ReadOnlySpan{T1})"/>
            public static unsafe void ClearTexSubImageEXT<T1>(int texture, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, PixelFormat format, PixelType type, Span<T1> data)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> data_r = data;
                ClearTexSubImageEXT(texture, level, xoffset, yoffset, zoffset, width, height, depth, format, type, data_r);
            }
            /// <inheritdoc cref="ClearTexSubImageEXT(int, int, int, int, int, int, int, int, PixelFormat, PixelType, void*)"/>
            ...
            /// <inheritdoc cref="CreateShaderProgramEXT(ShaderType, byte*)"/>
            public static unsafe int CreateShaderProgramEXT(ShaderType type, ReadOnlySpan<byte> nullTerminatedUtf8Str)
            {
                int returnValue;
                var nullTerminatedUtf8Str_span = NativeString.EnsureNullTerminated(nullTerminatedUtf8Str, out var nullTerminatedUtf8Str_array);
                fixed (byte* str_ptr = nullTerminatedUtf8Str_span)
                {
                    returnValue = CreateShaderProgramEXT(type, str_ptr);
                }
                if (nullTerminatedUtf8Str_array is not null) ArrayPool<byte>.Shared.Return(nullTerminatedUtf8Str_array, true);
                return returnValue;
            }
            ...
            /// <inheritdoc cref="GetFragDataIndexEXT(int, byte*)"/>
            public static unsafe int GetFragDataIndexEXT(int program, ReadOnlySpan<byte> nullTerminatedUtf8Name)
            {
                int returnValue;
                var nullTerminatedUtf8Name_span = NativeString.EnsureNullTerminated(nullTerminatedUtf8Name, out var nullTerminatedUtf8Name_array);
                fixed (byte* name_ptr = nullTerminatedUtf8Name_span)
            ...
            public static unsafe void GetFragmentShadingRatesEXT(int samples, out int count, Span<ShadingRate> shadingRates)
            {
                fixed (int* count_ptr = &count)
                {
                    fixed (ShadingRate* shadingRates_ptr = shadingRates)
                    {
                        var maxCount = shadingRates.Length;
            ...
            public static unsafe void GetObjectLabelEXT(All type, uint obj, out int length, Span<byte> label)
            {
                fixed (int* length_ptr = &length)
                {
                    fixed (byte* label_ptr = label)
            ...
            public static unsafe void GetProgramPipelineInfoLogEXT(int pipeline, out int length, Span<byte> infoLog)
            {
                fixed (int* length_ptr = &length)
                {
                    fixed (byte* infoLog_ptr = infoLog)
            ...
            /// <inheritdoc cref="GetProgramResourceLocationIndexEXT(int, ProgramInterface, byte*)"/>
            public static unsafe int GetProgramResourceLocationIndexEXT(int program, ProgramInterface programInterface, ReadOnlySpan<byte> nullTerminatedUtf8Name)
            {
                int returnValue;
                var nullTerminatedUtf8Name_span = NativeString.EnsureNullTerminated(nullTerminatedUtf8Name, out var nullTerminatedUtf8Name_array);
                fixed (byte* name_ptr = nullTerminatedUtf8Name_span)
            ...
            /// <inheritdoc cref="ImportMemoryWin32NameEXT{T1}(uint, ulong, ExternalHandleType, ReadOnlySpan{T1})"/>
            public static unsafe void ImportMemoryWin32NameEXT<T1>(uint memory, ulong size, ExternalHandleType handleType, Span<T1> name)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> name_r = name;
                ImportMemoryWin32NameEXT(memory, size, handleType, name_r);
            }
            /// <inheritdoc cref="ImportMemoryWin32NameEXT(uint, ulong, ExternalHandleType, void*)"/>
            ...
            /// <inheritdoc cref="ImportSemaphoreWin32NameEXT{T1}(uint, ExternalHandleType, ReadOnlySpan{T1})"/>
            public static unsafe void ImportSemaphoreWin32NameEXT<T1>(uint semaphore, ExternalHandleType handleType, Span<T1> name)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> name_r = name;
                ImportSemaphoreWin32NameEXT(semaphore, handleType, name_r);
            }
            /// <inheritdoc cref="ImportSemaphoreWin32NameEXT(uint, ExternalHandleType, void*)"/>
            ...
            /// <inheritdoc cref="LabelObjectEXT(All, uint, int, byte*)"/>
            public static unsafe void LabelObjectEXT(All type, uint obj, int length, ReadOnlySpan<byte> nullTerminatedUtf8Label)
            {
                var nullTerminatedUtf8Label_span = NativeString.EnsureNullTerminated(nullTerminatedUtf8Label, out var nullTerminatedUtf8Label_array);
                fixed (byte* label_ptr = nullTerminatedUtf8Label_span)
                {
            ...
            /// <inheritdoc cref="MultiDrawArraysIndirectEXT{T1}(PrimitiveType, ReadOnlySpan{T1}, int, int)"/>
            public static unsafe void MultiDrawArraysIndirectEXT<T1>(PrimitiveType mode, Span<T1> indirect, int drawcount, int stride)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> indirect_r = indirect;
                MultiDrawArraysIndirectEXT(mode, indirect_r, drawcount, stride);
            }
            /// <inheritdoc cref="MultiDrawArraysIndirectEXT(PrimitiveType, void*, int, int)"/>
            ...
            /// <inheritdoc cref="MultiDrawElementsIndirectEXT{T1}(PrimitiveType, DrawElementsType, ReadOnlySpan{T1}, int, int)"/>
            public static unsafe void MultiDrawElementsIndirectEXT<T1>(PrimitiveType mode, DrawElementsType type, Span<T1> indirect, int drawcount, int stride)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> indirect_r = indirect;
                MultiDrawElementsIndirectEXT(mode, type, indirect_r, drawcount, stride);
            }
            /// <inheritdoc cref="MultiDrawElementsIndirectEXT(PrimitiveType, DrawElementsType, void*, int, int)"/>
        ...
        public static unsafe partial class INTEL
        {
            ...
            public static unsafe void GetPerfCounterInfoINTEL(uint queryId, uint counterId, Span<byte> counterName, Span<byte> counterDesc, ref uint counterOffset, ref uint counterDataSize, ref uint counterTypeEnum, ref uint counterDataTypeEnum, ref ulong rawCounterMaxValue)
            {
                ...
                {
                    fixed (byte* counterDesc_ptr = counterDesc)
                    {
                        var counterDescLength = (uint)counterDesc.Length;
                        fixed (byte* counterName_ptr = counterName)
                        {
                            var counterNameLength = (uint)counterName.Length;
            ...
            /// <inheritdoc cref="GetPerfCounterInfoINTEL(uint, uint, uint, byte*, uint, byte*, uint*, uint*, uint*, uint*, ulong*)"/>
            public static unsafe void GetPerfCounterInfoINTEL(uint queryId, uint counterId, Span<byte> counterName, Span<byte> counterDesc, uint[] counterOffset, uint[] counterDataSize, uint[] counterTypeEnum, uint[] counterDataTypeEnum, ulong[] rawCounterMaxValue)
            {
                fixed (ulong* rawCounterMaxValue_ptr = rawCounterMaxValue)
                {
                    fixed (uint* counterDataTypeEnum_ptr = counterDataTypeEnum)
            ...
            /// <inheritdoc cref="GetPerfCounterInfoINTEL(uint, uint, uint, byte*, uint, byte*, uint*, uint*, uint*, uint*, ulong*)"/>
            public static unsafe void GetPerfCounterInfoINTEL(uint queryId, uint counterId, Span<byte> counterName, Span<byte> counterDesc, Span<uint> counterOffset, Span<uint> counterDataSize, Span<uint> counterTypeEnum, Span<uint> counterDataTypeEnum, Span<ulong> rawCounterMaxValue)
            {
                fixed (ulong* rawCounterMaxValue_ptr = rawCounterMaxValue)
                {
                    fixed (uint* counterDataTypeEnum_ptr = counterDataTypeEnum)
            ...
            public static unsafe void GetPerfQueryInfoINTEL(uint queryId, Span<byte> queryName, ref uint dataSize, ref uint noCounters, ref uint noInstances, ref PerformanceQueryCapsMaskINTEL capsMask)
            {
                ...
                {
                    fixed (byte* queryName_ptr = queryName)
                    {
                        var queryNameLength = (uint)queryName.Length;
                        GetPerfQueryInfoINTEL(queryId, queryNameLength, queryName_ptr, dataSize_ptr, noCounters_ptr, noInstances_ptr, capsMask_ptr);
                    }
                }
            }
            /// <inheritdoc cref="GetPerfQueryInfoINTEL(uint, uint, byte*, uint*, uint*, uint*, PerformanceQueryCapsMaskINTEL*)"/>
            public static unsafe void GetPerfQueryInfoINTEL(uint queryId, Span<byte> queryName, uint[] dataSize, uint[] noCounters, uint[] noInstances, PerformanceQueryCapsMaskINTEL[] capsMask)
            {
                fixed (PerformanceQueryCapsMaskINTEL* capsMask_ptr = capsMask)
                {
                    fixed (uint* noInstances_ptr = noInstances)
            ...
            /// <inheritdoc cref="GetPerfQueryInfoINTEL(uint, uint, byte*, uint*, uint*, uint*, PerformanceQueryCapsMaskINTEL*)"/>
            public static unsafe void GetPerfQueryInfoINTEL(uint queryId, Span<byte> queryName, Span<uint> dataSize, Span<uint> noCounters, Span<uint> noInstances, Span<PerformanceQueryCapsMaskINTEL> capsMask)
            {
                fixed (PerformanceQueryCapsMaskINTEL* capsMask_ptr = capsMask)
                {
                    fixed (uint* noInstances_ptr = noInstances)
        ...
        public static unsafe partial class KHR
        {
            ...
            /// <inheritdoc cref="DebugMessageCallbackKHR{T1}(GLDebugProcKHR, ReadOnlySpan{T1})"/>
            public static unsafe void DebugMessageCallbackKHR<T1>(GLDebugProcKHR callback, Span<T1> userParam)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> userParam_r = userParam;
                DebugMessageCallbackKHR(callback, userParam_r);
            }
            /// <inheritdoc cref="DebugMessageCallbackKHR(IntPtr, void*)"/>
            ...
            public static unsafe uint GetDebugMessageLogKHR(uint count, ref DebugSource sources, ref DebugType types, ref uint ids, ref DebugSeverity severities, ref int lengths, Span<byte> messageLog)
            {
                uint returnValue;
                fixed (DebugSource* sources_ptr = &sources)
                fixed (DebugType* types_ptr = &types)
            ...
            /// <inheritdoc cref="GetDebugMessageLogKHR(uint, int, DebugSource*, DebugType*, uint*, DebugSeverity*, int*, byte*)"/>
            public static unsafe uint GetDebugMessageLogKHR(uint count, DebugSource[] sources, DebugType[] types, uint[] ids, DebugSeverity[] severities, int[] lengths, Span<byte> messageLog)
            {
                uint returnValue;
                fixed (int* lengths_ptr = lengths)
                {
            ...
            /// <inheritdoc cref="GetDebugMessageLogKHR(uint, int, DebugSource*, DebugType*, uint*, DebugSeverity*, int*, byte*)"/>
            public static unsafe uint GetDebugMessageLogKHR(uint count, Span<DebugSource> sources, Span<DebugType> types, Span<uint> ids, Span<DebugSeverity> severities, Span<int> lengths, Span<byte> messageLog)
            {
                uint returnValue;
                fixed (int* lengths_ptr = lengths)
                {
            ...
            public static unsafe void GetObjectLabelKHR(All identifier, uint name, out int length, Span<byte> label)
            {
                fixed (int* length_ptr = &length)
                {
                    fixed (byte* label_ptr = label)
            ...
            public static unsafe void GetObjectPtrLabelKHR(IntPtr ptr, out int length, Span<byte> label)
            {
                fixed (int* length_ptr = &length)
                {
                    fixed (byte* label_ptr = label)
            ...
            /// <inheritdoc cref="GetObjectPtrLabelKHR(void*, int, int*, byte*)"/>
            public static unsafe void GetObjectPtrLabelKHR<T1>(ref readonly T1 ptr, out int length, Span<byte> label)
                where T1 : unmanaged
            {
                fixed (void* ptr_ptr = &ptr)
                fixed (int* length_ptr = &length)
            ...
            /// <inheritdoc cref="GetObjectPtrLabelKHR(void*, int, int*, byte*)"/>
            public static unsafe void GetObjectPtrLabelKHR<T1>(T1[] ptr, out int length, Span<byte> label)
                where T1 : unmanaged
            {
                fixed (int* length_ptr = &length)
                {
            ...
            /// <inheritdoc cref="GetObjectPtrLabelKHR{T1}(ReadOnlySpan{T1}, out int, Span{byte})"/>
            public static unsafe void GetObjectPtrLabelKHR<T1>(Span<T1> ptr, out int length, Span<byte> label)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> ptr_r = ptr;
                GetObjectPtrLabelKHR(ptr_r, out length, label);
            }
            /// <inheritdoc cref="GetObjectPtrLabelKHR(void*, int, int*, byte*)"/>
            public static unsafe void GetObjectPtrLabelKHR<T1>(ReadOnlySpan<T1> ptr, out int length, Span<byte> label)
                where T1 : unmanaged
            {
                fixed (int* length_ptr = &length)
                {
            ...
            /// <inheritdoc cref="GetObjectPtrLabelKHR{T1}(ReadOnlySpan{T1}, int, out int)"/>
            public static unsafe string GetObjectPtrLabelKHR<T1>(Span<T1> ptr, int bufSize, out int length)
                where T1 : unmanaged
            {
                string returnValue;
                ReadOnlySpan<T1> ptr_r = ptr;
                returnValue = GetObjectPtrLabelKHR(ptr_r, bufSize, out length);
                return returnValue;
            }
            /// <inheritdoc cref="GetObjectPtrLabelKHR(void*, int, int*, byte*)"/>
            ...
            /// <inheritdoc cref="GetObjectPtrLabelKHR{T1}(ReadOnlySpan{T1}, int, out int, out string)"/>
            public static unsafe void GetObjectPtrLabelKHR<T1>(Span<T1> ptr, int bufSize, out int length, out string label)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> ptr_r = ptr;
                GetObjectPtrLabelKHR(ptr_r, bufSize, out length, out label);
            }
            /// <inheritdoc cref="GetObjectPtrLabelKHR(void*, int, int*, byte*)"/>
            ...
            /// <inheritdoc cref="ObjectPtrLabelKHR{T1}(ReadOnlySpan{T1}, int, string)"/>
            public static unsafe void ObjectPtrLabelKHR<T1>(Span<T1> ptr, int length, string label)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> ptr_r = ptr;
                ObjectPtrLabelKHR(ptr_r, length, label);
            }
            /// <inheritdoc cref="ObjectPtrLabelKHR(void*, int, byte*)"/>
            ...
            /// <inheritdoc cref="ObjectPtrLabelKHR(void*, int, byte*)"/>
            public static unsafe void ObjectPtrLabelKHR<T1>(ref readonly T1 ptr, int length, ReadOnlySpan<byte> nullTerminatedUtf8Label)
                where T1 : unmanaged
            {
                fixed (void* ptr_ptr = &ptr)
                {
            ...
            /// <inheritdoc cref="ObjectPtrLabelKHR(void*, int, byte*)"/>
            public static unsafe void ObjectPtrLabelKHR<T1>(T1[] ptr, int length, ReadOnlySpan<byte> nullTerminatedUtf8Label)
                where T1 : unmanaged
            {
                fixed (void* ptr_ptr = ptr)
                {
            ...
            public static unsafe void ObjectPtrLabelKHR<T1>(Span<T1> ptr, int length, ReadOnlySpan<byte> nullTerminatedUtf8Label)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> ptr_r = ptr;
                ObjectPtrLabelKHR(ptr_r, length, nullTerminatedUtf8Label);
            }
            /// <inheritdoc cref="ObjectPtrLabelKHR(void*, int, byte*)"/>
            public static unsafe void ObjectPtrLabelKHR<T1>(ReadOnlySpan<T1> ptr, int length, ReadOnlySpan<byte> nullTerminatedUtf8Label)
                where T1 : unmanaged
            {
                fixed (void* ptr_ptr = ptr)
                {
        ...
        public static unsafe partial class NV
        {
            ...
            /// <inheritdoc cref="CoverFillPathInstancedNV{T1}(int, PathElementType, ReadOnlySpan{T1}, uint, InstancedPathCoverMode, PathTransformType, ReadOnlySpan{float})"/>
            public static unsafe void CoverFillPathInstancedNV<T1>(int numPaths, PathElementType pathNameType, Span<T1> paths, uint pathBase, InstancedPathCoverMode coverMode, PathTransformType transformType, ReadOnlySpan<float> transformValues)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> paths_r = paths;
                CoverFillPathInstancedNV(numPaths, pathNameType, paths_r, pathBase, coverMode, transformType, transformValues);
            }
            /// <inheritdoc cref="CoverFillPathInstancedNV(int, PathElementType, void*, uint, InstancedPathCoverMode, PathTransformType, float*)"/>
            ...
            /// <inheritdoc cref="CoverStrokePathInstancedNV{T1}(int, PathElementType, ReadOnlySpan{T1}, uint, InstancedPathCoverMode, PathTransformType, ReadOnlySpan{float})"/>
            public static unsafe void CoverStrokePathInstancedNV<T1>(int numPaths, PathElementType pathNameType, Span<T1> paths, uint pathBase, InstancedPathCoverMode coverMode, PathTransformType transformType, ReadOnlySpan<float> transformValues)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> paths_r = paths;
                CoverStrokePathInstancedNV(numPaths, pathNameType, paths_r, pathBase, coverMode, transformType, transformValues);
            }
            /// <inheritdoc cref="CoverStrokePathInstancedNV(int, PathElementType, void*, uint, InstancedPathCoverMode, PathTransformType, float*)"/>
            ...
            /// <inheritdoc cref="GetPathMetricsNV{T1}(PathMetricMask, int, PathElementType, ReadOnlySpan{T1}, uint, int, Span{float})"/>
            public static unsafe void GetPathMetricsNV<T1>(PathMetricMask metricQueryMask, int numPaths, PathElementType pathNameType, Span<T1> paths, uint pathBase, int stride, Span<float> metrics)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> paths_r = paths;
                GetPathMetricsNV(metricQueryMask, numPaths, pathNameType, paths_r, pathBase, stride, metrics);
            }
            /// <inheritdoc cref="GetPathMetricsNV(PathMetricMask, int, PathElementType, void*, uint, int, float*)"/>
            ...
            /// <inheritdoc cref="GetPathSpacingNV{T1}(PathListMode, int, PathElementType, ReadOnlySpan{T1}, uint, float, float, PathTransformType, Span{float})"/>
            public static unsafe void GetPathSpacingNV<T1>(PathListMode pathListMode, int numPaths, PathElementType pathNameType, Span<T1> paths, uint pathBase, float advanceScale, float kerningScale, PathTransformType transformType, Span<float> returnedSpacing)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> paths_r = paths;
                GetPathSpacingNV(pathListMode, numPaths, pathNameType, paths_r, pathBase, advanceScale, kerningScale, transformType, returnedSpacing);
            }
            /// <inheritdoc cref="GetPathSpacingNV(PathListMode, int, PathElementType, void*, uint, float, float, PathTransformType, float*)"/>
            ...
            public static unsafe void GetProgramResourcefvNV(int program, ProgramInterface programInterface, uint index, int propCount, ref readonly All props, out int length, Span<float> parameters)
            {
            ...
            /// <inheritdoc cref="GetProgramResourcefvNV(int, ProgramInterface, uint, int, All*, int, int*, float*)"/>
            public static unsafe void GetProgramResourcefvNV(int program, ProgramInterface programInterface, uint index, int propCount, All[] props, out int length, Span<float> parameters)
            {
                fixed (int* length_ptr = &length)
                {
                    fixed (All* props_ptr = props)
            ...
            /// <inheritdoc cref="GetProgramResourcefvNV(int, ProgramInterface, uint, int, All*, int, int*, float*)"/>
            public static unsafe void GetProgramResourcefvNV(int program, ProgramInterface programInterface, uint index, int propCount, ReadOnlySpan<All> props, out int length, Span<float> parameters)
            {
                fixed (int* length_ptr = &length)
                {
                    fixed (All* props_ptr = props)
            ...
            /// <inheritdoc cref="GetProgramResourcefvNV(int, ProgramInterface, uint, int, All*, int, int*, float*)"/>
            public static unsafe void GetProgramResourcefvNV(int program, ProgramInterface programInterface, uint index, int propCount, ReadOnlySpan<All> props, int count, out int length, ref float parameters)
            {
                fixed (int* length_ptr = &length)
                fixed (float* parameters_ptr = &parameters)
                {
            ...
            /// <inheritdoc cref="GetVkProcAddrNV(byte*)"/>
            public static unsafe IntPtr GetVkProcAddrNV(ReadOnlySpan<byte> nullTerminatedUtf8Name)
            {
                IntPtr returnValue;
                var nullTerminatedUtf8Name_span = NativeString.EnsureNullTerminated(nullTerminatedUtf8Name, out var nullTerminatedUtf8Name_array);
                fixed (byte* name_ptr = nullTerminatedUtf8Name_span)
            ...
            /// <inheritdoc cref="PathCommandsNV(uint, int, byte*, int, PathCoordType, void*)"/>
            public static unsafe void PathCommandsNV<T1>(uint path, ReadOnlySpan<byte> commands, int numCoords, PathCoordType coordType, ref readonly T1 coords)
                where T1 : unmanaged
            {
            ...
            /// <inheritdoc cref="PathCommandsNV(uint, int, byte*, int, PathCoordType, void*)"/>
            public static unsafe void PathCommandsNV<T1>(uint path, ReadOnlySpan<byte> commands, int numCoords, PathCoordType coordType, T1[] coords)
                where T1 : unmanaged
            {
                fixed (void* coords_ptr = coords)
                {
            ...
            /// <inheritdoc cref="PathCommandsNV{T1}(uint, ReadOnlySpan{byte}, int, PathCoordType, ReadOnlySpan{T1})"/>
            public static unsafe void PathCommandsNV<T1>(uint path, ReadOnlySpan<byte> commands, int numCoords, PathCoordType coordType, Span<T1> coords)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> coords_r = coords;
                PathCommandsNV(path, commands, numCoords, coordType, coords_r);
            }
            /// <inheritdoc cref="PathCommandsNV(uint, int, byte*, int, PathCoordType, void*)"/>
            ...
            /// <inheritdoc cref="PathCommandsNV{T1}(uint, int, ref readonly byte, int, PathCoordType, ReadOnlySpan{T1})"/>
            public static unsafe void PathCommandsNV<T1>(uint path, int numCommands, ref readonly byte commands, int numCoords, PathCoordType coordType, Span<T1> coords)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> coords_r = coords;
                PathCommandsNV(path, numCommands, in commands, numCoords, coordType, coords_r);
            }
            /// <inheritdoc cref="PathCommandsNV(uint, int, byte*, int, PathCoordType, void*)"/>
            public static unsafe void PathCommandsNV<T1>(uint path, int numCommands, ref readonly byte commands, int numCoords, PathCoordType coordType, ReadOnlySpan<T1> coords)
                where T1 : unmanaged
            {
                fixed (byte* commands_ptr = &commands)
                {
            ...
            /// <inheritdoc cref="PathCoordsNV{T1}(uint, int, PathCoordType, ReadOnlySpan{T1})"/>
            public static unsafe void PathCoordsNV<T1>(uint path, int numCoords, PathCoordType coordType, Span<T1> coords)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> coords_r = coords;
                PathCoordsNV(path, numCoords, coordType, coords_r);
            }
            /// <inheritdoc cref="PathCoordsNV(uint, int, PathCoordType, void*)"/>
            ...
            /// <inheritdoc cref="PathGlyphIndexArrayNV{T1}(uint, All, ReadOnlySpan{T1}, PathFontStyle, uint, int, uint, float)"/>
            public static unsafe All PathGlyphIndexArrayNV<T1>(uint firstPathName, All fontTarget, Span<T1> fontName, PathFontStyle fontStyle, uint firstGlyphIndex, int numGlyphs, uint pathParameterTemplate, float emScale)
                where T1 : unmanaged
            {
                All returnValue;
                ReadOnlySpan<T1> fontName_r = fontName;
                returnValue = PathGlyphIndexArrayNV(firstPathName, fontTarget, fontName_r, fontStyle, firstGlyphIndex, numGlyphs, pathParameterTemplate, emScale);
                return returnValue;
            }
            /// <inheritdoc cref="PathGlyphIndexArrayNV(uint, All, void*, PathFontStyle, uint, int, uint, float)"/>
            ...
            /// <inheritdoc cref="PathGlyphIndexRangeNV{T1}(All, ReadOnlySpan{T1}, PathFontStyle, uint, float, Span{uint})"/>
            public static unsafe All PathGlyphIndexRangeNV<T1>(All fontTarget, Span<T1> fontName, PathFontStyle fontStyle, uint pathParameterTemplate, float emScale, Span<uint> baseAndCount)
                where T1 : unmanaged
            {
                All returnValue;
                ReadOnlySpan<T1> fontName_r = fontName;
                returnValue = PathGlyphIndexRangeNV(fontTarget, fontName_r, fontStyle, pathParameterTemplate, emScale, baseAndCount);
                return returnValue;
            }
            /// <inheritdoc cref="PathGlyphIndexRangeNV(All, void*, PathFontStyle, uint, float, uint*)"/>
            ...
            /// <inheritdoc cref="PathGlyphRangeNV{T1}(uint, PathFontTarget, ReadOnlySpan{T1}, PathFontStyle, uint, int, PathHandleMissingGlyphs, uint, float)"/>
            public static unsafe void PathGlyphRangeNV<T1>(uint firstPathName, PathFontTarget fontTarget, Span<T1> fontName, PathFontStyle fontStyle, uint firstGlyph, int numGlyphs, PathHandleMissingGlyphs handleMissingGlyphs, uint pathParameterTemplate, float emScale)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> fontName_r = fontName;
                PathGlyphRangeNV(firstPathName, fontTarget, fontName_r, fontStyle, firstGlyph, numGlyphs, handleMissingGlyphs, pathParameterTemplate, emScale);
            }
            /// <inheritdoc cref="PathGlyphRangeNV(uint, PathFontTarget, void*, PathFontStyle, uint, int, PathHandleMissingGlyphs, uint, float)"/>
            ...
            /// <inheritdoc cref="PathGlyphsNV{T1, T2}(uint, PathFontTarget, ReadOnlySpan{T1}, PathFontStyle, int, PathElementType, ReadOnlySpan{T2}, PathHandleMissingGlyphs, uint, float)"/>
            public static unsafe void PathGlyphsNV<T1, T2>(uint firstPathName, PathFontTarget fontTarget, Span<T1> fontName, PathFontStyle fontStyle, int numGlyphs, PathElementType type, Span<T2> charcodes, PathHandleMissingGlyphs handleMissingGlyphs, uint pathParameterTemplate, float emScale)
                where T1 : unmanaged
                where T2 : unmanaged
            {
                ReadOnlySpan<T2> charcodes_r = charcodes;
                ReadOnlySpan<T1> fontName_r = fontName;
                PathGlyphsNV(firstPathName, fontTarget, fontName_r, fontStyle, numGlyphs, type, charcodes_r, handleMissingGlyphs, pathParameterTemplate, emScale);
            }
            /// <inheritdoc cref="PathGlyphsNV(uint, PathFontTarget, void*, PathFontStyle, int, PathElementType, void*, PathHandleMissingGlyphs, uint, float)"/>
            ...
            /// <inheritdoc cref="PathMemoryGlyphIndexArrayNV{T1}(uint, All, nint, ReadOnlySpan{T1}, int, uint, int, uint, float)"/>
            public static unsafe All PathMemoryGlyphIndexArrayNV<T1>(uint firstPathName, All fontTarget, nint fontSize, Span<T1> fontData, int faceIndex, uint firstGlyphIndex, int numGlyphs, uint pathParameterTemplate, float emScale)
                where T1 : unmanaged
            {
                All returnValue;
                ReadOnlySpan<T1> fontData_r = fontData;
                returnValue = PathMemoryGlyphIndexArrayNV(firstPathName, fontTarget, fontSize, fontData_r, faceIndex, firstGlyphIndex, numGlyphs, pathParameterTemplate, emScale);
                return returnValue;
            }
            /// <inheritdoc cref="PathMemoryGlyphIndexArrayNV(uint, All, nint, void*, int, uint, int, uint, float)"/>
            ...
            /// <inheritdoc cref="PathStringNV{T1}(uint, PathStringFormat, ReadOnlySpan{T1})"/>
            public static unsafe void PathStringNV<T1>(uint path, PathStringFormat format, Span<T1> pathString)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> pathString_r = pathString;
                PathStringNV(path, format, pathString_r);
            }
            /// <inheritdoc cref="PathStringNV(uint, PathStringFormat, int, void*)"/>
            ...
            /// <inheritdoc cref="PathSubCommandsNV(uint, int, int, int, byte*, int, PathCoordType, void*)"/>
            public static unsafe void PathSubCommandsNV<T1>(uint path, int commandStart, int commandsToDelete, ReadOnlySpan<byte> commands, int numCoords, PathCoordType coordType, ref readonly T1 coords)
                where T1 : unmanaged
            {
                fixed (void* coords_ptr = &coords)
                {
            ...
            /// <inheritdoc cref="PathSubCommandsNV(uint, int, int, int, byte*, int, PathCoordType, void*)"/>
            public static unsafe void PathSubCommandsNV<T1>(uint path, int commandStart, int commandsToDelete, ReadOnlySpan<byte> commands, int numCoords, PathCoordType coordType, T1[] coords)
                where T1 : unmanaged
            {
                fixed (void* coords_ptr = coords)
                {
            ...
            /// <inheritdoc cref="PathSubCommandsNV{T1}(uint, int, int, ReadOnlySpan{byte}, int, PathCoordType, ReadOnlySpan{T1})"/>
            public static unsafe void PathSubCommandsNV<T1>(uint path, int commandStart, int commandsToDelete, ReadOnlySpan<byte> commands, int numCoords, PathCoordType coordType, Span<T1> coords)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> coords_r = coords;
                PathSubCommandsNV(path, commandStart, commandsToDelete, commands, numCoords, coordType, coords_r);
            }
            /// <inheritdoc cref="PathSubCommandsNV(uint, int, int, int, byte*, int, PathCoordType, void*)"/>
            ...
            /// <inheritdoc cref="PathSubCommandsNV{T1}(uint, int, int, int, ref readonly byte, int, PathCoordType, ReadOnlySpan{T1})"/>
            public static unsafe void PathSubCommandsNV<T1>(uint path, int commandStart, int commandsToDelete, int numCommands, ref readonly byte commands, int numCoords, PathCoordType coordType, Span<T1> coords)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> coords_r = coords;
                PathSubCommandsNV(path, commandStart, commandsToDelete, numCommands, in commands, numCoords, coordType, coords_r);
            }
            /// <inheritdoc cref="PathSubCommandsNV(uint, int, int, int, byte*, int, PathCoordType, void*)"/>
            public static unsafe void PathSubCommandsNV<T1>(uint path, int commandStart, int commandsToDelete, int numCommands, ref readonly byte commands, int numCoords, PathCoordType coordType, ReadOnlySpan<T1> coords)
                where T1 : unmanaged
            {
                fixed (byte* commands_ptr = &commands)
                {
            ...
            /// <inheritdoc cref="PathSubCoordsNV{T1}(uint, int, int, PathCoordType, ReadOnlySpan{T1})"/>
            public static unsafe void PathSubCoordsNV<T1>(uint path, int coordStart, int numCoords, PathCoordType coordType, Span<T1> coords)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> coords_r = coords;
                PathSubCoordsNV(path, coordStart, numCoords, coordType, coords_r);
            }
            /// <inheritdoc cref="PathSubCoordsNV(uint, int, int, PathCoordType, void*)"/>
            ...
            /// <inheritdoc cref="StencilFillPathInstancedNV{T1}(int, PathElementType, ReadOnlySpan{T1}, uint, PathFillMode, uint, PathTransformType, ReadOnlySpan{float})"/>
            public static unsafe void StencilFillPathInstancedNV<T1>(int numPaths, PathElementType pathNameType, Span<T1> paths, uint pathBase, PathFillMode fillMode, uint mask, PathTransformType transformType, ReadOnlySpan<float> transformValues)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> paths_r = paths;
                StencilFillPathInstancedNV(numPaths, pathNameType, paths_r, pathBase, fillMode, mask, transformType, transformValues);
            }
            /// <inheritdoc cref="StencilFillPathInstancedNV(int, PathElementType, void*, uint, PathFillMode, uint, PathTransformType, float*)"/>
            ...
            /// <inheritdoc cref="StencilStrokePathInstancedNV{T1}(int, PathElementType, ReadOnlySpan{T1}, uint, int, uint, PathTransformType, ReadOnlySpan{float})"/>
            public static unsafe void StencilStrokePathInstancedNV<T1>(int numPaths, PathElementType pathNameType, Span<T1> paths, uint pathBase, int reference, uint mask, PathTransformType transformType, ReadOnlySpan<float> transformValues)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> paths_r = paths;
                StencilStrokePathInstancedNV(numPaths, pathNameType, paths_r, pathBase, reference, mask, transformType, transformValues);
            }
            /// <inheritdoc cref="StencilStrokePathInstancedNV(int, PathElementType, void*, uint, int, uint, PathTransformType, float*)"/>
            ...
            /// <inheritdoc cref="StencilThenCoverFillPathInstancedNV{T1}(int, PathElementType, ReadOnlySpan{T1}, uint, PathFillMode, uint, InstancedPathCoverMode, PathTransformType, ReadOnlySpan{float})"/>
            public static unsafe void StencilThenCoverFillPathInstancedNV<T1>(int numPaths, PathElementType pathNameType, Span<T1> paths, uint pathBase, PathFillMode fillMode, uint mask, InstancedPathCoverMode coverMode, PathTransformType transformType, ReadOnlySpan<float> transformValues)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> paths_r = paths;
                StencilThenCoverFillPathInstancedNV(numPaths, pathNameType, paths_r, pathBase, fillMode, mask, coverMode, transformType, transformValues);
            }
            /// <inheritdoc cref="StencilThenCoverFillPathInstancedNV(int, PathElementType, void*, uint, PathFillMode, uint, InstancedPathCoverMode, PathTransformType, float*)"/>
            ...
            /// <inheritdoc cref="StencilThenCoverStrokePathInstancedNV{T1}(int, PathElementType, ReadOnlySpan{T1}, uint, int, uint, InstancedPathCoverMode, PathTransformType, ReadOnlySpan{float})"/>
            public static unsafe void StencilThenCoverStrokePathInstancedNV<T1>(int numPaths, PathElementType pathNameType, Span<T1> paths, uint pathBase, int reference, uint mask, InstancedPathCoverMode coverMode, PathTransformType transformType, ReadOnlySpan<float> transformValues)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> paths_r = paths;
                StencilThenCoverStrokePathInstancedNV(numPaths, pathNameType, paths_r, pathBase, reference, mask, coverMode, transformType, transformValues);
            }
            /// <inheritdoc cref="StencilThenCoverStrokePathInstancedNV(int, PathElementType, void*, uint, int, uint, InstancedPathCoverMode, PathTransformType, float*)"/>
        ...
        public static unsafe partial class OES
        {
            ...
            /// <inheritdoc cref="CompressedTexImage3DOES{T1}(TextureTarget, int, InternalFormat, int, int, int, int, ReadOnlySpan{T1})"/>
            public static unsafe void CompressedTexImage3DOES<T1>(TextureTarget target, int level, InternalFormat internalformat, int width, int height, int depth, int border, Span<T1> data)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> data_r = data;
                CompressedTexImage3DOES(target, level, internalformat, width, height, depth, border, data_r);
            }
            /// <inheritdoc cref="CompressedTexImage3DOES(TextureTarget, int, InternalFormat, int, int, int, int, int, void*)"/>
            ...
            /// <inheritdoc cref="CompressedTexSubImage3DOES{T1}(TextureTarget, int, int, int, int, int, int, int, InternalFormat, ReadOnlySpan{T1})"/>
            public static unsafe void CompressedTexSubImage3DOES<T1>(TextureTarget target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, InternalFormat format, Span<T1> data)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> data_r = data;
                CompressedTexSubImage3DOES(target, level, xoffset, yoffset, zoffset, width, height, depth, format, data_r);
            }
            /// <inheritdoc cref="CompressedTexSubImage3DOES(TextureTarget, int, int, int, int, int, int, int, InternalFormat, int, void*)"/>
            ...
            /// <inheritdoc cref="GetProgramBinaryOES(int, int, int*, All*, void*)"/>
            public static unsafe void GetProgramBinaryOES<T1>(int program, out int length, out All binaryFormat, Span<T1> binary)
                where T1 : unmanaged
            {
                fixed (int* length_ptr = &length)
                fixed (All* binaryFormat_ptr = &binaryFormat)
            ...
            /// <inheritdoc cref="ProgramBinaryOES{T1}(int, All, ReadOnlySpan{T1})"/>
            public static unsafe void ProgramBinaryOES<T1>(int program, All binaryFormat, Span<T1> binary)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> binary_r = binary;
                ProgramBinaryOES(program, binaryFormat, binary_r);
            }
            /// <inheritdoc cref="ProgramBinaryOES(int, All, void*, int)"/>
            ...
            /// <inheritdoc cref="TexImage3DOES{T1}(TextureTarget, int, InternalFormat, int, int, int, int, PixelFormat, PixelType, ReadOnlySpan{T1})"/>
            public static unsafe void TexImage3DOES<T1>(TextureTarget target, int level, InternalFormat internalformat, int width, int height, int depth, int border, PixelFormat format, PixelType type, Span<T1> pixels)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> pixels_r = pixels;
                TexImage3DOES(target, level, internalformat, width, height, depth, border, format, type, pixels_r);
            }
            /// <inheritdoc cref="TexImage3DOES(TextureTarget, int, InternalFormat, int, int, int, int, PixelFormat, PixelType, void*)"/>
            ...
            /// <inheritdoc cref="TexSubImage3DOES{T1}(TextureTarget, int, int, int, int, int, int, int, PixelFormat, PixelType, ReadOnlySpan{T1})"/>
            public static unsafe void TexSubImage3DOES<T1>(TextureTarget target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, PixelFormat format, PixelType type, Span<T1> pixels)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> pixels_r = pixels;
                TexSubImage3DOES(target, level, xoffset, yoffset, zoffset, width, height, depth, format, type, pixels_r);
            }
            /// <inheritdoc cref="TexSubImage3DOES(TextureTarget, int, int, int, int, int, int, int, PixelFormat, PixelType, void*)"/>
        ...
        public static unsafe partial class QCOM
        {
            ...
            public static unsafe int ExtGetBuffersQCOM(Span<int> buffers)
            {
                int numBuffers;
            ...
            /// <inheritdoc cref="ExtGetBuffersQCOM(int*, int, int*)"/>
            public static unsafe void ExtGetBuffersQCOM(Span<int> buffers, out int numBuffers)
            {
            ...
            public static unsafe int ExtGetFramebuffersQCOM(Span<int> framebuffers)
            {
                int numFramebuffers;
                int* numFramebuffers_ptr = &numFramebuffers;
                {
                    fixed (int* framebuffers_ptr = framebuffers)
                    {
                        var maxFramebuffers = framebuffers.Length;
            ...
            /// <inheritdoc cref="ExtGetFramebuffersQCOM(int*, int, int*)"/>
            public static unsafe void ExtGetFramebuffersQCOM(Span<int> framebuffers, out int numFramebuffers)
            {
            ...
            public static unsafe void ExtGetProgramBinarySourceQCOM(int program, ShaderType shadertype, Span<byte> source)
            {
                fixed (byte* source_ptr = source)
                {
                    var length = (int*)source.Length;
                    ExtGetProgramBinarySourceQCOM(program, shadertype, source_ptr, length);
                }
            }
            /// <inheritdoc cref="ExtGetProgramBinarySourceQCOM(int, ShaderType, byte*, int*)"/>
            ...
            public static unsafe int ExtGetProgramsQCOM(Span<int> programs)
            {
                int numPrograms;
                int* numPrograms_ptr = &numPrograms;
                {
                    ...
                    {
                        var maxPrograms = programs.Length;
            ...
            /// <inheritdoc cref="ExtGetProgramsQCOM(int*, int, int*)"/>
            public static unsafe void ExtGetProgramsQCOM(Span<int> programs, out int numPrograms)
            {
            ...
            public static unsafe int ExtGetRenderbuffersQCOM(Span<int> renderbuffers)
            {
                ...
                int* numRenderbuffers_ptr = &numRenderbuffers;
                {
                    fixed (int* renderbuffers_ptr = renderbuffers)
                    {
                        var maxRenderbuffers = renderbuffers.Length;
            ...
            /// <inheritdoc cref="ExtGetRenderbuffersQCOM(int*, int, int*)"/>
            public static unsafe void ExtGetRenderbuffersQCOM(Span<int> renderbuffers, out int numRenderbuffers)
            {
            ...
            public static unsafe int ExtGetShadersQCOM(Span<int> shaders)
            {
                int numShaders;
            ...
            /// <inheritdoc cref="ExtGetShadersQCOM(int*, int, int*)"/>
            public static unsafe void ExtGetShadersQCOM(Span<int> shaders, out int numShaders)
            {
            ...
            public static unsafe void GetDriverControlsQCOM(ref int num, Span<uint> driverControls)
            {
                fixed (int* num_ptr = &num)
                {
                    ...
                    {
                        var size = driverControls.Length;
                        GetDriverControlsQCOM(num_ptr, size, driverControls_ptr);
                    }
                }
            }
            /// <inheritdoc cref="GetDriverControlsQCOM(int*, int, uint*)"/>
            public static unsafe void GetDriverControlsQCOM(int[] num, Span<uint> driverControls)
            {
                fixed (int* num_ptr = num)
                {
                    fixed (uint* driverControls_ptr = driverControls)
            ...
            /// <inheritdoc cref="GetDriverControlsQCOM(int*, int, uint*)"/>
            public static unsafe void GetDriverControlsQCOM(Span<int> num, Span<uint> driverControls)
            {
                fixed (int* num_ptr = num)
                {
                    fixed (uint* driverControls_ptr = driverControls)
            ...
            /// <inheritdoc cref="GetDriverControlsQCOM(int*, int, uint*)"/>
            public static unsafe void GetDriverControlsQCOM(Span<int> num, int size, ref uint driverControls)
            {
                fixed (uint* driverControls_ptr = &driverControls)
                {
                    fixed (int* num_ptr = num)
            ...
            public static unsafe void GetDriverControlStringQCOM(uint driverControl, ref int length, Span<byte> driverControlString)
            {
                fixed (int* length_ptr = &length)
                {
                    fixed (byte* driverControlString_ptr = driverControlString)
                    {
                        var bufSize = driverControlString.Length;
                        GetDriverControlStringQCOM(driverControl, bufSize, length_ptr, driverControlString_ptr);
                    }
                }
            }
            /// <inheritdoc cref="GetDriverControlStringQCOM(uint, int, int*, byte*)"/>
            public static unsafe void GetDriverControlStringQCOM(uint driverControl, int[] length, Span<byte> driverControlString)
            {
                fixed (int* length_ptr = length)
                {
                    fixed (byte* driverControlString_ptr = driverControlString)
            ...
            /// <inheritdoc cref="GetDriverControlStringQCOM(uint, int, int*, byte*)"/>
            public static unsafe void GetDriverControlStringQCOM(uint driverControl, Span<int> length, Span<byte> driverControlString)
            {
                fixed (int* length_ptr = length)
                {
                    fixed (byte* driverControlString_ptr = driverControlString)
