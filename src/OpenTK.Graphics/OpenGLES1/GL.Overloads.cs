...
namespace OpenTK.Graphics.OpenGLES1
{
    public static unsafe partial class GL
    {
        ...
        /// <inheritdoc cref="ColorPointer{T1}(int, ColorPointerType, int, ReadOnlySpan{T1})"/>
        public static unsafe void ColorPointer<T1>(int size, ColorPointerType type, int stride, Span<T1> pointer)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> pointer_r = pointer;
            ColorPointer(size, type, stride, pointer_r);
        }
        /// <inheritdoc cref="ColorPointer(int, ColorPointerType, int, void*)"/>
        ...
        /// <inheritdoc cref="NormalPointer{T1}(NormalPointerType, int, ReadOnlySpan{T1})"/>
        public static unsafe void NormalPointer<T1>(NormalPointerType type, int stride, Span<T1> pointer)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> pointer_r = pointer;
            NormalPointer(type, stride, pointer_r);
        }
        /// <inheritdoc cref="NormalPointer(NormalPointerType, int, void*)"/>
        ...
        /// <inheritdoc cref="TexCoordPointer{T1}(int, TexCoordPointerType, int, ReadOnlySpan{T1})"/>
        public static unsafe void TexCoordPointer<T1>(int size, TexCoordPointerType type, int stride, Span<T1> pointer)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> pointer_r = pointer;
            TexCoordPointer(size, type, stride, pointer_r);
        }
        /// <inheritdoc cref="TexCoordPointer(int, TexCoordPointerType, int, void*)"/>
        ...
        /// <inheritdoc cref="VertexPointer{T1}(int, VertexPointerType, int, ReadOnlySpan{T1})"/>
        public static unsafe void VertexPointer<T1>(int size, VertexPointerType type, int stride, Span<T1> pointer)
            where T1 : unmanaged
        {
            ReadOnlySpan<T1> pointer_r = pointer;
            VertexPointer(size, type, stride, pointer_r);
        }
        /// <inheritdoc cref="VertexPointer(int, VertexPointerType, int, void*)"/>
        ...
        public static unsafe partial class OES
        {
            ...
            /// <inheritdoc cref="MatrixIndexPointerOES{T1}(int, MatrixIndexPointerTypeARB, int, ReadOnlySpan{T1})"/>
            public static unsafe void MatrixIndexPointerOES<T1>(int size, MatrixIndexPointerTypeARB type, int stride, Span<T1> pointer)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> pointer_r = pointer;
                MatrixIndexPointerOES(size, type, stride, pointer_r);
            }
            /// <inheritdoc cref="MatrixIndexPointerOES(int, MatrixIndexPointerTypeARB, int, void*)"/>
            ...
            /// <inheritdoc cref="PointSizePointerOES{T1}(All, int, ReadOnlySpan{T1})"/>
            public static unsafe void PointSizePointerOES<T1>(All type, int stride, Span<T1> pointer)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> pointer_r = pointer;
                PointSizePointerOES(type, stride, pointer_r);
            }
            /// <inheritdoc cref="PointSizePointerOES(All, int, void*)"/>
            ...
            /// <inheritdoc cref="WeightPointerOES{T1}(int, All, int, ReadOnlySpan{T1})"/>
            public static unsafe void WeightPointerOES<T1>(int size, All type, int stride, Span<T1> pointer)
                where T1 : unmanaged
            {
                ReadOnlySpan<T1> pointer_r = pointer;
                WeightPointerOES(size, type, stride, pointer_r);
            }
            /// <inheritdoc cref="WeightPointerOES(int, All, int, void*)"/>
