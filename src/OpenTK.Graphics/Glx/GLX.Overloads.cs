...
namespace OpenTK.Graphics.Glx
{
    public static unsafe partial class Glx
    {
        ...
        public static unsafe string? GetClientString(DisplayPtr dpy, StringName name, [ConstantExpected] NativeCharacterEncoding resultEncoding = NativeCharacterEncoding.Utf8)
        {
        ...
        /// <inheritdoc cref="GetClientString_(DisplayPtr, StringName)"/>
        public static unsafe ReadOnlySpan<byte> GetClientStringAsSpan(DisplayPtr dpy, StringName name)
        {
        ...
        public static unsafe string? QueryExtensionsString(DisplayPtr dpy, int screen, [ConstantExpected] NativeCharacterEncoding resultEncoding = NativeCharacterEncoding.Utf8)
        {
            string? returnValue_str;
            byte* returnValue;
        ...
        /// <inheritdoc cref="QueryExtensionsString_(DisplayPtr, int)"/>
        public static unsafe ReadOnlySpan<byte> QueryExtensionsStringAsSpan(DisplayPtr dpy, int screen)
        {
            ReadOnlySpan<byte> returnValue_str;
            byte* returnValue;
            returnValue = QueryExtensionsString_(dpy, screen);
        ...
        public static unsafe string? QueryServerString(DisplayPtr dpy, int screen, StringName name, [ConstantExpected] NativeCharacterEncoding resultEncoding = NativeCharacterEncoding.Utf8)
        {
            string? returnValue_str;
            byte* returnValue;
        ...
        /// <inheritdoc cref="QueryServerString_(DisplayPtr, int, StringName)"/>
        public static unsafe ReadOnlySpan<byte> QueryServerStringAsSpan(DisplayPtr dpy, int screen, StringName name)
        {
            ReadOnlySpan<byte> returnValue_str;
            byte* returnValue;
            returnValue = QueryServerString_(dpy, screen, name);
        ...
        public static unsafe partial class MESA
        {
            ...
            /// <inheritdoc cref="GetAGPOffsetMESA{T1}(ReadOnlySpan{T1})"/>
            public static unsafe uint GetAGPOffsetMESA<T1>(Span<T1> pointer)
                where T1 : unmanaged
            {
                uint returnValue;
                ReadOnlySpan<T1> pointer_r = pointer;
                returnValue = GetAGPOffsetMESA(pointer_r);
                return returnValue;
            }
            /// <inheritdoc cref="GetAGPOffsetMESA(void*)"/>
            ...
            public static unsafe string? QueryCurrentRendererStringMESA(int attribute, [ConstantExpected] NativeCharacterEncoding resultEncoding = NativeCharacterEncoding.Utf8)
            {
                string? returnValue_str;
                byte* returnValue;
            ...
            /// <inheritdoc cref="QueryCurrentRendererStringMESA_(int)"/>
            public static unsafe ReadOnlySpan<byte> QueryCurrentRendererStringMESAAsSpan(int attribute)
            {
                ReadOnlySpan<byte> returnValue_str;
                byte* returnValue;
                returnValue = QueryCurrentRendererStringMESA_(attribute);
            ...
            public static unsafe string? QueryRendererStringMESA(DisplayPtr dpy, int screen, int renderer, int attribute, [ConstantExpected] NativeCharacterEncoding resultEncoding = NativeCharacterEncoding.Utf8)
            {
                string? returnValue_str;
                byte* returnValue;
            ...
            /// <inheritdoc cref="QueryRendererStringMESA_(DisplayPtr, int, int, int)"/>
            public static unsafe ReadOnlySpan<byte> QueryRendererStringMESAAsSpan(DisplayPtr dpy, int screen, int renderer, int attribute)
            {
                ReadOnlySpan<byte> returnValue_str;
                byte* returnValue;
                returnValue = QueryRendererStringMESA_(dpy, screen, renderer, attribute);
