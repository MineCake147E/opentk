...
namespace OpenTK.Graphics.Egl
{
    public static unsafe partial class Egl
    {
        ...
        public static unsafe bool GetConfig(EGLDisplay dpy, Span<EGLConfig> configs, out int num_config)
        {
            bool returnValue_bool;
            fixed (int* num_config_ptr = &num_config)
            {
                fixed (EGLConfig* configs_ptr = configs)
                {
                    var config_size = configs.Length;
                    int returnValue;
        ...
        public static unsafe string? QueryString(EGLDisplay dpy, StringName name, [ConstantExpected] NativeCharacterEncoding resultEncoding = NativeCharacterEncoding.Utf8)
        {
        ...
        /// <inheritdoc cref="QueryString_(EGLDisplay, StringName)"/>
        public static unsafe ReadOnlySpan<byte> QueryStringAsSpan(EGLDisplay dpy, StringName name)
        {
        ...
        public static unsafe partial class ANGLE
        {
            ...
            /// <inheritdoc cref="ProgramCachePopulateANGLE{T1, T2}(EGLDisplay, ReadOnlySpan{T1}, int, ReadOnlySpan{T2}, int)"/>
            public static unsafe void ProgramCachePopulateANGLE<T1, T2>(EGLDisplay dpy, Span<T1> key, int keysize, Span<T2> binary, int binarysize)
                where T1 : unmanaged
                where T2 : unmanaged
            {
                ReadOnlySpan<T2> binary_r = binary;
                ReadOnlySpan<T1> key_r = key;
                ProgramCachePopulateANGLE(dpy, key_r, keysize, binary_r, binarysize);
            }
            /// <inheritdoc cref="ProgramCachePopulateANGLE(EGLDisplay, void*, int, void*, int)"/>
            ...
            public static unsafe string? QueryStringiANGLE(EGLDisplay dpy, int name, int index, [ConstantExpected] NativeCharacterEncoding resultEncoding = NativeCharacterEncoding.Utf8)
            {
                string? returnValue_str;
                byte* returnValue;
            ...
            /// <inheritdoc cref="QueryStringiANGLE_(EGLDisplay, int, int)"/>
            public static unsafe ReadOnlySpan<byte> QueryStringiANGLEAsSpan(EGLDisplay dpy, int name, int index)
            {
                ReadOnlySpan<byte> returnValue_str;
                byte* returnValue;
                returnValue = QueryStringiANGLE_(dpy, name, index);
        ...
        public static unsafe partial class EXT
        {
            ...
            public static unsafe string? QueryDeviceStringEXT(EGLDeviceEXT device, int name, [ConstantExpected] NativeCharacterEncoding resultEncoding = NativeCharacterEncoding.Utf8)
            {
                string? returnValue_str;
                byte* returnValue;
            ...
            /// <inheritdoc cref="QueryDeviceStringEXT_(EGLDeviceEXT, int)"/>
            public static unsafe ReadOnlySpan<byte> QueryDeviceStringEXTAsSpan(EGLDeviceEXT device, int name)
            {
                ReadOnlySpan<byte> returnValue_str;
                byte* returnValue;
                returnValue = QueryDeviceStringEXT_(device, name);
            ...
            public static unsafe string? QueryOutputLayerStringEXT(EGLDisplay dpy, EGLOutputLayerEXT layer, int name, [ConstantExpected] NativeCharacterEncoding resultEncoding = NativeCharacterEncoding.Utf8)
            {
                string? returnValue_str;
                byte* returnValue;
            ...
            /// <inheritdoc cref="QueryOutputLayerStringEXT_(EGLDisplay, EGLOutputLayerEXT, int)"/>
            public static unsafe ReadOnlySpan<byte> QueryOutputLayerStringEXTAsSpan(EGLDisplay dpy, EGLOutputLayerEXT layer, int name)
            {
                ReadOnlySpan<byte> returnValue_str;
                byte* returnValue;
                returnValue = QueryOutputLayerStringEXT_(dpy, layer, name);
            ...
            public static unsafe string? QueryOutputPortStringEXT(EGLDisplay dpy, EGLOutputPortEXT port, int name, [ConstantExpected] NativeCharacterEncoding resultEncoding = NativeCharacterEncoding.Utf8)
            {
                string? returnValue_str;
                byte* returnValue;
            ...
            /// <inheritdoc cref="QueryOutputPortStringEXT_(EGLDisplay, EGLOutputPortEXT, int)"/>
            public static unsafe ReadOnlySpan<byte> QueryOutputPortStringEXTAsSpan(EGLDisplay dpy, EGLOutputPortEXT port, int name)
            {
                ReadOnlySpan<byte> returnValue_str;
                byte* returnValue;
                returnValue = QueryOutputPortStringEXT_(dpy, port, name);
        ...
        public static unsafe partial class MESA
        {
            ...
            public static unsafe string? GetDisplayDriverConfig(EGLDisplay dpy, [ConstantExpected] NativeCharacterEncoding resultEncoding = NativeCharacterEncoding.Utf8)
            {
                string? returnValue_str;
                byte* returnValue;
            ...
            /// <inheritdoc cref="GetDisplayDriverConfig_(EGLDisplay)"/>
            public static unsafe ReadOnlySpan<byte> GetDisplayDriverConfigAsSpan(EGLDisplay dpy)
            {
                ReadOnlySpan<byte> returnValue_str;
                byte* returnValue;
                returnValue = GetDisplayDriverConfig_(dpy);
            ...
            public static unsafe string? GetDisplayDriverName(EGLDisplay dpy, [ConstantExpected] NativeCharacterEncoding resultEncoding = NativeCharacterEncoding.Utf8)
            {
                string? returnValue_str;
                byte* returnValue;
            ...
            /// <inheritdoc cref="GetDisplayDriverName_(EGLDisplay)"/>
            public static unsafe ReadOnlySpan<byte> GetDisplayDriverNameAsSpan(EGLDisplay dpy)
            {
                ReadOnlySpan<byte> returnValue_str;
                byte* returnValue;
                returnValue = GetDisplayDriverName_(dpy);
        ...
        public static unsafe partial class NV
        {
            ...
            /// <inheritdoc cref="SetStreamMetadataNV{T1}(EGLDisplay, EGLStreamKHR, int, int, int, ReadOnlySpan{T1})"/>
            public static unsafe bool SetStreamMetadataNV<T1>(EGLDisplay dpy, EGLStreamKHR stream, int n, int offset, int size, Span<T1> data)
                where T1 : unmanaged
            {
                bool returnValue;
                ReadOnlySpan<T1> data_r = data;
                returnValue = SetStreamMetadataNV(dpy, stream, n, offset, size, data_r);
                return returnValue;
            }
            /// <inheritdoc cref="SetStreamMetadataNV(EGLDisplay, EGLStreamKHR, int, int, int, void*)"/>
